...
const TecModule = require('./app/TEC_server');
const TecRoute = require('./routes/TEC.routes');
const MatchingModule = require('./app/Matching_server');
const MatchingRoute = require('./routes/Matching.routes');
//
...
// use smart contract routes
app.use('/tec',TecRoute);
